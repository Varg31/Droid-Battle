...
public class Droideka {
  ...
  final double Luck =0.3;
  final double AttackSpeed=1.2;
  final double CritChance=0.2;
  ...
  public void PrintInfo(){
    System.out.println("Droididetka is heavy droid class with high attack power and high shields");
  }

  @Override
  public String toString()
  {
    return String.format("Your Health is"+Health+"Your Armor is"+Armor+"Your Shield is"+Shield);
  }
